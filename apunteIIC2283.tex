...
\definecolor{strongorange}{RGB}{255,100,0}
...
{Teorema}{fonttitle=\bfseries\upshape, fontupper=\slshape,
    ...
    right=4pt,
    colback=white,
    colframe=black!75!white}{theorem}
...
\newcommand{\definicion}[3]{\begin{defi}{#1}{#2}#3\end{defi}\vspace{1pt}}
...
\include{ch2/contenido2}
\include{ch2/ejercicios2}

\include{ch3/contenido3}
\include{ch3/ejercicios3}

\include{ch4/contenido4}
\include{ch4/ejercicios4}

\include{ch5/contenido5}
\include{ch5/ejercicios5}

\include{ch6/contenido6}
\include{ch6/ejercicios6}

\include{ch7/contenido7}
\include{ch7/ejercicios7}

\include{ch8/contenido8}
